...
export function Hero() {
  ...
  return (
    <section className="kbpm-hi-fi w-full bg-white px-4 pt-0 sm:px-6 lg:px-8">
      ...
      <div className="relative -mt-[4.5rem] flex w-full min-h-[32rem] flex-col justify-between overflow-hidden rounded-2xl bg-[#1e1e1e] px-5 pb-6 pt-[7rem] sm:-mt-[5.5rem] sm:min-h-[40rem] sm:px-8 sm:pb-10 sm:pt-[8.25rem] lg:-mt-[6.5rem] lg:min-h-[min(90vh,56.25rem)] lg:px-[clamp(2.5rem,5vw,5rem)] lg:pb-20 lg:pt-[10.5rem]">
        <h1 className="font-display relative z-10 max-w-4xl py-10 text-[2.125rem] font-medium leading-[1.2] tracking-[-0.02em] text-white sm:py-14 sm:text-5xl lg:max-w-5xl lg:py-4 lg:text-[4.5rem]">
